        ...
        .aksi-tambah{
            ...
            <div class="admin--container" id="admin">
                <div class="table-container" id="table">
                    ...
                    <h2 style="font-size:2rem;font-weight: 450;padding-block: 10px;">Update Pelanggan</h2>
                    <div class="container-tambah-data" id="contambahData">
                       <h3 style="font-weight: 450;margin-bottom:30px;text-transform: capitalize">update Data Pelanggan</h3>
                       <div style="padding-left: 70px">
                         <form method="POST"  action="updatepelanggan/?id={{$pelanggan->id}}" class="form" id="myForm" >
                            @method("PUT")
                            @csrf
                            <div class="mb-4">

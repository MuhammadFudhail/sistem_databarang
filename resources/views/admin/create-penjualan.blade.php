    ...
    .aksi-tambah{
        ...
        <div class="admin--container" id="admin">
            <div class="table-container" id="table">
                ...
                <h2 style="font-size:2rem;font-weight: 450;padding-block: 10px;">Tambahkan Penjualan</h2>
                <div class="container-tambah-data" id="contambahData">
                   <h3 style="font-weight: 450;margin-bottom:30px;text-transform: capitalize">Tambah Data Penjualan</h3>
                   <div style="padding-left: 70px">
                     <form action="{{route('admin.storepenjualan')}}" class="form" id="myForm" method="POST" >
                        @csrf
                        <div class="mb-4">
